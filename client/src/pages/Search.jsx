    ...
    <div className='flex flex-col md:flex-row'>
      <div className='p-7 border-b-2 border-gray-300 md:border-r-2 md:min-h-screen'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          ...
          <button className='bg-slate-700 hover:bg-slate-800 text-white p-3 rounded-lg uppercase'>Search</button>
        </form>
      </div>
      <div className='flex-1'>
        <h1 className='text-stone-600 text-3xl font-semibold border-b border-gray-300 p-3 mt-5'>
          Listing Results:
        </h1>
          ...
          {showMore && (
            <div className='p-7 text-center w-full'>
              <span 
                ...
                className='text-blue-700 hover:text-blue-800 hover:underline font-semibold cursor-pointer'
              >
                Show more
              </span>
            </div>
