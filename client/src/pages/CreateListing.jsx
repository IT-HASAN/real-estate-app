...
export default function CreateListing() {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
      <h1 className='text-stone-600 text-3xl font-semibold text-center my-7'>Create a Listing</h1>
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-col flex-1 gap-2'>
          ...
          {confirmedFiles.length > 0 && confirmedFiles.map((item, index) => (
          ...
          <button disabled={submitting || confirmedFiles.length === 0} className='p-3 bg-slate-700 hover:bg-slate-800 text-white rounded-lg uppercase disabled:opacity-80'>
