      ...
      <div className='z-10 w-[30%] max-[1024px]:w-[50%] max-[800px]:w-[80%] h-fit flex flex-col items-center justify-start  bg-slate-400 shadow-md rounded-lg'>
        ...
        <div className='px-10 pb-3 mt-5'>
          ...
          <div className='flex justify-around mt-5 w-full'>
            <button className='bg-slate-700 text-white rounded-lg px-2 py-1 uppercase hover:opacity-95' onClick={closeDeleteModal}>Cancel</button>
            <button className='bg-red-700 text-white rounded-lg px-2 py-1 uppercase hover:opacity-95' onClick={handleDelete}>Delete</button>
          </div>
        </div>
      </div>
    </div>
